#ifndef LLPRefitProcessor_h
#define LLPRefitProcessor_h 1
...
class LLPRefitProcessor : public marlin::Processor {

public:

  virtual marlin::Processor*  newProcessor() { return new LLPRefitProcessor ; }
